                ...
                {tmpNews ? tmpNews.map((news) => (
                    <div key={news.id} className="news-card">
                        ...
                        <div className="news-btn-div">
                            ...
                            {isAdmin ? (
                                <div>
                                    <button className="news-admin-btn" onClick={(e, id) => {handleDeleteClick(e, id)}}><svg
                                    ...
                                    <button className="news-admin-btn" onClick={() => handleOpenAddModal(news)}><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth={2.1}
